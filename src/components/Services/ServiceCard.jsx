  ...
  return (
    <div className='py-[30px] px-3 lg:px-5'>
      ...
      <div className='flex items-center justify-between mt-[30px]'>
        ...
        <Link to='/developers' className='w-[44px] h-[44px] rounded-full border border-solid border-[#18141E]  flex items-center justify-center group hover:bg-yellowColor hover:border-none'>
